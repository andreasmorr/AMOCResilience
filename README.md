...
Geographic box perturbation sweep of the 2D latitude-depth Boussinesq SPDE model. Salinity perturbations are applied to coherent geographic boxes (Arctic, tropical, southern ocean) across a range of Arctic amplification values γ, mapping out basins of attraction and mean convergence times in the Boussinesq AMOC.
