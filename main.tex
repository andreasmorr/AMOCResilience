...
\begin{table}[t]
  ...
  \begin{tabular}{p{2.3cm} p{3.2cm} p{3.2cm} p{3.2cm} p{3.2cm}}
    ...
    Minimal critical shock
      & Minimum salinity-plane distance from the on state to a sampled initial conditions in a region of $\pm 2$psu around the on state not converging to the on state.
      & Minimum salinity-plane distance from the on state to a valid sampled initial condition not converging to the on state.
      & Minimum salinity-plane distance from the on-state to a initial condition not converging to the on state.
