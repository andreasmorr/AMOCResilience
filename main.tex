...
\begin{figure}[t]
  ...
  This overview compares the geographic salinity regions used as perturbation coordinates (shaded regions) in the Boussinesq and CLIMBER-X experiments and as diagnostic readouts (dashed boxes) in the Boussinesq, CLIMBER-X, and PlaSim-LSG analysis. The box geometry associated with the 3-box model is approximately reproduced from the model conception in \cite{Wood20195BoxModel}.}
